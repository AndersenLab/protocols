...
1. Determine the titer of embryos by counting the number of embryos in 5 µL. Adjust the volume of K-media to obtain the desired concentration (~0.5 - 1 embryo per µL). 
